...
public class Main {
	...
	public static void main(String[] args) {
		...
		Main m1 = new Main();
		m1.run(500000, 1, 10, 0.000001, 0.25, 0.35, 0.65);
//		m1.noiseRun(50000, 1, 5, 0.00001, 0.15, 0.35, 0.65);
//		m1.noiseRun(50000, 1, 5, 0.00001, 0.05, 0.35, 0.65);
		
//		m1.noiseRun(300000, 1, 5, 0.00001, 0.15, 0.35, 0.65);
//		m1.noiseRun(100000, 1, 5, 0.00001, 0.05, 0.35, 0.65);

//		m1.noiseRun(100000, 1, 5, 0.00001, 0.25, 0.15, 0.85);
		
		
		
	//	m1.noiseRun(100000, 1, 10, 0.000003, 0.25, 0.35, 0.65);	// done
	//	m1.noiseRun(100000, 1, 30, 0.000001, 0.25, 0.35, 0.65);
	//	m1.noiseRun(100000, 1, 10, 0.000003, 0.4, 0.45, 0.55);
	//	m1.noiseRun(100000, 1, 30, 0.000001, 0.4, 0.45, 0.55);
		
	//	m1.noiseRun(500000, 1, 10, 0.00000001, 0.25, 0.35, 0.65);
	//	m1.noiseRun(500000, 1, 30, 0.00000001, 0.25, 0.35, 0.65);
	//	m1.noiseRun(500000, 1, 10, 0.00000001, 0.4, 0.45, 0.55);
	//	m1.noiseRun(500000, 1, 30, 0.000000005, 0.4, 0.45, 0.55);
		/*
